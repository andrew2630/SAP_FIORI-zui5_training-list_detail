		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zui5traininglistdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zui5traininglistdetail-display": {
								"semanticObject": "zui5traininglistdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zui5traininglistdetail",
									"url": sap.ui.require.toUrl("zui5traininglistdetail")
								}
							}
						}
					}
